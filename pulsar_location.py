...
J0030_DEC_SUB =_J0030.create_dataset('DEC_SUB', (10,1), maxshape=(None,1), dtype=np.float64)
...
J0051_DEC_SUB =_J0051.create_dataset('DEC_SUB', (10,1), maxshape=(None,1), dtype=np.float64)
